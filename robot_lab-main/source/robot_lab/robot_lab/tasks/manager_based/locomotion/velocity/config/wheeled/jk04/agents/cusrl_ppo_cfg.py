...
@dataclass
class JK04RoughTrainerCfg(TrainerCfg):
    max_iterations = 20000
    save_interval = 100
    experiment_name = "jk04_rough"
    agent_factory = cusrl.ActorCritic.Factory(
        # Match the RSL-RL JK04 PPO setup: longer rollouts and smaller updates
...
@dataclass
class JK04FlatTrainerCfg(JK04RoughTrainerCfg):
    max_iterations = 5000
    experiment_name = "jk04_flat"


@dataclass
class JK04FlatYawTrainerCfg(JK04FlatTrainerCfg):
    max_iterations = 5000
    experiment_name = "jk04_flat_yaw"
