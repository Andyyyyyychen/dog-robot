...
class JK03RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # ------------------------------Actions------------------------------
        # reduce action scale
        self.actions.joint_pos.scale = {".*_hipx_joint": 0.10, "^(?!.*_hipx_joint).*": 0.24}
        ...
        self.rewards.create_joint_deviation_l1_rewterm("joint_deviation_hipx_l1", -0.35, [".*_hipx_joint"])
        ...
        self.rewards.joint_pos_penalty.weight = -1.15
