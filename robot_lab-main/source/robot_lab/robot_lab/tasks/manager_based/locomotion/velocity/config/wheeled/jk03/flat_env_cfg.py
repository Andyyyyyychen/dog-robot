...
class JK03FlatEnvCfg(JK03RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.yaw_wheel_velocity_alignment.weight = 0.1
        ...
        self.rewards.yaw_turn_joint_posture_l2.weight = -0.25
        ...
        self.rewards.joint_deviation_hipx_l1.weight = -0.50
        ...
        self.rewards.feet_slide.params["yaw_slide_scale"] = 0.3
        ...
        self.rewards.yaw_turn_feet_clearance.weight = 0.38
        ...
        self.rewards.yaw_turn_feet_clearance.params["min_air_time"] = 0.01
        ...
        self.rewards.yaw_turn_tangential_swing.weight = 0.22
        ...
        self.rewards.yaw_turn_tangential_swing.params["target_height"] = -0.235
        self.rewards.yaw_turn_tangential_swing.params["min_air_time"] = 0.01
        ...
        self.rewards.yaw_front_wheel_participation.weight = 0.05
        ...
        self.rewards.yaw_front_lift_tangential_participation.weight = 0.35
        ...
        self.rewards.yaw_front_lift_tangential_participation.params["target_height"] = -0.235
        self.rewards.yaw_front_lift_tangential_participation.params["min_air_time"] = 0.012
        self.rewards.yaw_front_lift_tangential_participation.params["max_air_time"] = 0.40
        self.rewards.yaw_front_lift_tangential_participation.params["target_tangential_speed"] = 0.10
        self.rewards.yaw_front_lift_tangential_participation.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.yaw_rear_drag_without_front_penalty.weight = -0.16
        ...
        self.rewards.yaw_wheel_lateral_separation_penalty.weight = -0.25
        ...
        self.rewards.yaw_wheel_lateral_separation_penalty.params["min_front_separation"] = 0.42
        self.rewards.yaw_wheel_lateral_separation_penalty.params["min_rear_separation"] = 0.38
        self.rewards.yaw_wheel_lateral_separation_penalty.params["max_abs_lateral"] = 0.40
...
class JK03FlatYawEnvCfg(JK03FlatEnvCfg):
    def __post_init__(self):
        ...
        # A narrow pretraining stage for in-place yaw turns.  It removes forward
        # and lateral commands so exploration is spent on diagonal stepping
        ...
        self.rewards.track_ang_vel_z_exp.weight = 2.0
        self.rewards.yaw_command_progress.weight = 0.6
        self.rewards.yaw_command_progress.params["max_yaw_rate"] = 0.45
        self.rewards.yaw_wheel_differential_progress.weight = 0.10
        self.rewards.yaw_wheel_differential_progress.params["max_xy_command"] = 1.20
        self.rewards.yaw_wheel_differential_progress.params["asset_cfg"].joint_names = self.wheel_joint_names
        self.rewards.yaw_wheel_velocity_alignment.weight = 0.05
        ...
        self.rewards.feet_slide.params["yaw_slide_scale"] = 0.3
        self.rewards.feet_gait.weight = 0
        self.rewards.yaw_turn_feet_clearance.weight = 0.45
        self.rewards.yaw_turn_diagonal_step.weight = 0.10
        self.rewards.yaw_turn_air_time_deficit.weight = 0
        self.rewards.yaw_turn_phase_timeout.weight = 0
        self.rewards.yaw_turn_tangential_swing.weight = 0.28
        self.rewards.yaw_front_wheel_participation.weight = 0.08
        self.rewards.yaw_front_lift_tangential_participation.weight = 0.50
        self.rewards.yaw_rear_drag_without_front_penalty.weight = -0.20
        self.rewards.yaw_wheel_lateral_separation_penalty.weight = -0.35
        self.rewards.yaw_hipx_twist_without_yaw_progress.weight = 0
        self.rewards.yaw_hipx_twist_without_yaw_progress.params["asset_cfg"].joint_names = ".*_hipx_joint"
