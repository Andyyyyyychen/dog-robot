...
class JK03FlatEnvCfg(JK03RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.yaw_wheel_differential_progress.params["max_xy_command"] = 0.16
        ...
        self.rewards.yaw_turn_joint_posture_l2.weight = -1.20
        ...
        self.rewards.feet_slide.params["yaw_slide_scale"] = 0.25
...
class JK03FlatYawEnvCfg(JK03FlatEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.yaw_command_progress.weight = 1.00
        self.rewards.yaw_wheel_differential_progress.weight = 1.50
        self.rewards.yaw_wheel_differential_progress.params["asset_cfg"].joint_names = self.wheel_joint_names
        self.rewards.yaw_stuck_with_command.weight = -7.0
        self.rewards.feet_slide.weight = -0.70
        self.rewards.feet_slide.params["command_name"] = "base_velocity"
        self.rewards.feet_slide.params["yaw_slide_scale"] = 0.20
        self.rewards.feet_gait.weight = 0
        self.rewards.yaw_turn_feet_clearance.weight = 0
        self.rewards.yaw_turn_diagonal_step.weight = 0
        self.rewards.yaw_turn_air_time_deficit.weight = 0
        ...
        self.rewards.yaw_turn_tangential_swing.weight = 0
        self.rewards.joint_pos_penalty.weight = -0.35
        self.rewards.yaw_turn_joint_posture_l2.weight = -1.40
