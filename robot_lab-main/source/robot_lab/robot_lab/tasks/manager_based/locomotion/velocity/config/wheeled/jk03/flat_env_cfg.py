...
class JK03FlatEnvCfg(JK03RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.yaw_turn_feet_clearance.weight = 0.55
        ...
        self.rewards.yaw_turn_tangential_swing.weight = 0.35
        ...
        self.rewards.yaw_rear_drag_without_front_penalty.weight = -0.18
...
class JK03FlatYawEnvCfg(JK03FlatEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.feet_slide.params["yaw_slide_scale"] = 0.3
        self.rewards.feet_gait.weight = 0
        self.rewards.yaw_turn_feet_clearance.weight = 0.70
        self.rewards.yaw_turn_diagonal_step.weight = 0.10
        self.rewards.yaw_turn_air_time_deficit.weight = 0
        self.rewards.yaw_turn_phase_timeout.weight = 0
        self.rewards.yaw_turn_tangential_swing.weight = 0.45
        self.rewards.yaw_front_wheel_participation.weight = 0.08
        self.rewards.yaw_front_lift_tangential_participation.weight = 1.00
        self.rewards.yaw_rear_drag_without_front_penalty.weight = -0.22
