...
@configclass
class JK04RewardsCfg(RewardsCfg):
...
class JK04RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    rewards: JK04RewardsCfg = JK04RewardsCfg()
    ...
    def __post_init__(self):
        ...
        # Keep base velocity visible to the actor for JK04 retraining. The
        ...
        if self.__class__.__name__ == "JK04RoughEnvCfg":
